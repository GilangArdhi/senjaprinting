      ...
      <div class="container">
        ...
        <div class="product-display">
          ...
          <div class="product-display__details">
            ...
            <!-- <div class="product-display__row"><span class="product-display__row-title">Color:</span>
              <ul class="colors-list">
                <li class="color-item"><span class="black"></span></li>
                <li class="color-item"><span class="pink"></span></li>
                <li class="color-item"><span class="blue"></span></li>
                <li class="color-item"><span class="white"></span></li>
              </ul>
            </div> -->
            <form action={{ url('/masuk-keranjang') }} method="POST">
              @csrf
              <div class="product-display__row">
                <div class="product-display__sub-row"><span class="product-display__row-title">Size:</span><a class="product-display__link" href="#">See size table</a></div>
                <div class="input-container">
                  <select class="select-input" id="size" name="size">
              ...
              <div class="product-display__row"><span class="product-display__row-title">Quantity:</span>
                <div>
                  ...
                  <input class="number-input" type="number" id="quantity" name="quantity" min="1" max="99" value="1">
        ...
        <div class="product-page__tab">
          ...
          <div class="product-page__tab-content flex--center" id="product-description">
            ...
            <div class="tab-content__item">
              <svg xmlns="http://www.w3.org/2000/svg" width="52.111" height="67" viewBox="0 0 52.111 67">
                <g transform="translate(-15 -5)" opacity="0.1">
                  <path d="M67.111,70.139V16.167a2.14,2.14,0,0,0-.521-1.34L57.284,5.521A2.14,2.14,0,0,0,55.944,5H16.861A1.843,1.843,0,0,0,15,6.861V70.139A1.843,1.843,0,0,0,16.861,72H65.25A1.843,1.843,0,0,0,67.111,70.139ZM55.944,9.467l6.7,6.7h-6.7Zm7.444,58.811H18.722V8.722h33.5v9.306a1.843,1.843,0,0,0,1.861,1.861h9.306Z" transform="translate(0)"></path>
                  <path d="M57.917,45H31.861a1.861,1.861,0,1,0,0,3.722H57.917a1.861,1.861,0,0,0,0-3.722Z" transform="translate(-3.833 -10.222)"></path>
                  <path d="M31.861,35a1.861,1.861,0,1,0,0,3.722H57.917a1.861,1.861,0,0,0,0-3.722Z" transform="translate(-3.833 -7.667)"></path>
                  <path d="M57.917,55H31.861a1.861,1.861,0,1,0,0,3.722H57.917a1.861,1.861,0,1,0,0-3.722Z" transform="translate(-3.833 -12.778)"></path>
                  <path d="M57.917,65H31.861a1.861,1.861,0,1,0,0,3.722H57.917a1.861,1.861,0,1,0,0-3.722Z" transform="translate(-3.833 -15.333)"></path>
                  <path d="M57.917,75H31.861a1.861,1.861,0,1,0,0,3.722H57.917a1.861,1.861,0,1,0,0-3.722Z" transform="translate(-3.833 -17.889)"></path>
                </g>
              </svg>
              <div class="default-title--sm">Details and product description</div>
          ...
          <div class="product-page__tab-content grid-tab" id="product-reviews" style="display: none;">
            <div class="rating-display__score">
              <div class="rating-score">4.5</div>
              <div class="rating-score-stars">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="98" height="13.351" viewBox="0 0 98 13.351">
                  <defs>
                    <linearGradient id="g11" x1="0.5" y1="0.5" x2="0.541" y2="0.5" gradientUnits="objectBoundingBox">
                      <stop offset="0" stop-color="#fbb03b"></stop>
                      <stop offset="1" stop-color="#c2c2c2">   </stop>
                    </linearGradient>
                  </defs>
                  <g transform="translate(-255 -1137.476)">
                    <path d="M18.979,12.158c-.057-.175-.2-.293-.622-.332l-3.867-.359a.476.476,0,0,1-.447-.324L12.508,7.576c-.168-.391-.324-.489-.508-.489s-.34.1-.508.489L9.956,11.142a.476.476,0,0,1-.447.324l-3.866.359c-.424.04-.565.157-.622.332s-.012.353.308.634l2.917,2.563a.477.477,0,0,1,.171.525l-.854,3.788c-.093.415-.025.586.124.694s.332.121.7-.1l3.339-1.982a.475.475,0,0,1,.552,0l3.339,1.982c.366.217.55.2.7.1s.217-.279.124-.694l-.854-3.788a.477.477,0,0,1,.171-.526l2.917-2.563C18.991,12.511,19.036,12.333,18.979,12.158Z" transform="translate(250 1130.389)" fill="#fbb03b"></path>
                    <path d="M18.979,12.158c-.057-.175-.2-.293-.622-.332l-3.867-.359a.476.476,0,0,1-.447-.324L12.508,7.576c-.168-.391-.324-.489-.508-.489s-.34.1-.508.489L9.956,11.142a.476.476,0,0,1-.447.324l-3.866.359c-.424.04-.565.157-.622.332s-.012.353.308.634l2.917,2.563a.477.477,0,0,1,.171.525l-.854,3.788c-.093.415-.025.586.124.694s.332.121.7-.1l3.339-1.982a.475.475,0,0,1,.552,0l3.339,1.982c.366.217.55.2.7.1s.217-.279.124-.694l-.854-3.788a.477.477,0,0,1,.171-.526l2.917-2.563C18.991,12.511,19.036,12.333,18.979,12.158Z" transform="translate(271 1130.389)" fill="#fbb03b"></path>
                    <path d="M18.979,12.158c-.057-.175-.2-.293-.622-.332l-3.867-.359a.476.476,0,0,1-.447-.324L12.508,7.576c-.168-.391-.324-.489-.508-.489s-.34.1-.508.489L9.956,11.142a.476.476,0,0,1-.447.324l-3.866.359c-.424.04-.565.157-.622.332s-.012.353.308.634l2.917,2.563a.477.477,0,0,1,.171.525l-.854,3.788c-.093.415-.025.586.124.694s.332.121.7-.1l3.339-1.982a.475.475,0,0,1,.552,0l3.339,1.982c.366.217.55.2.7.1s.217-.279.124-.694l-.854-3.788a.477.477,0,0,1,.171-.526l2.917-2.563C18.991,12.511,19.036,12.333,18.979,12.158Z" transform="translate(292 1130.389)" fill="#fbb03b"></path>
                    <path d="M18.979,12.158c-.057-.175-.2-.293-.622-.332l-3.867-.359a.476.476,0,0,1-.447-.324L12.508,7.576c-.168-.391-.324-.489-.508-.489s-.34.1-.508.489L9.956,11.142a.476.476,0,0,1-.447.324l-3.866.359c-.424.04-.565.157-.622.332s-.012.353.308.634l2.917,2.563a.477.477,0,0,1,.171.525l-.854,3.788c-.093.415-.025.586.124.694s.332.121.7-.1l3.339-1.982a.475.475,0,0,1,.552,0l3.339,1.982c.366.217.55.2.7.1s.217-.279.124-.694l-.854-3.788a.477.477,0,0,1,.171-.526l2.917-2.563C18.991,12.511,19.036,12.333,18.979,12.158Z" transform="translate(313 1130.389)" fill="#fbb03b"></path>
                    <path d="M18.979,12.158c-.057-.175-.2-.293-.622-.332l-3.867-.359a.476.476,0,0,1-.447-.324L12.508,7.576c-.168-.391-.324-.489-.508-.489s-.34.1-.508.489L9.956,11.142a.476.476,0,0,1-.447.324l-3.866.359c-.424.04-.565.157-.622.332s-.012.353.308.634l2.917,2.563a.477.477,0,0,1,.171.525l-.854,3.788c-.093.415-.025.586.124.694s.332.121.7-.1l3.339-1.982a.475.475,0,0,1,.552,0l3.339,1.982c.366.217.55.2.7.1s.217-.279.124-.694l-.854-3.788a.477.477,0,0,1,.171-.526l2.917-2.563C18.991,12.511,19.036,12.333,18.979,12.158Z" transform="translate(334 1130.389)" fill="url(#g11)"></path>
                  </g>
                </svg>
              </div>
              <div class="rating-nbr-users">
                <svg xmlns="http://www.w3.org/2000/svg" width="11" height="13.444" viewBox="0 0 11 13.444">
                  <path d="M43,40.833a.611.611,0,0,1-1.222,0,4.278,4.278,0,0,0-8.556,0,.611.611,0,0,1-1.222,0,5.5,5.5,0,1,1,11,0Zm-5.5-6.111a3.361,3.361,0,1,1,3.361-3.361A3.361,3.361,0,0,1,37.5,34.722Zm0-1.222a2.139,2.139,0,1,0-2.139-2.139A2.139,2.139,0,0,0,37.5,33.5Z" transform="translate(-32 -28)" fill="#b9b9b9"></path>
                </svg><span>81 all opinions</span>
              </div>
            </div>
            <div class="rating-display__bars">
              <div class="rating-bar">
                <div class="star">
                  <svg xmlns="http://www.w3.org/2000/svg" width="13" height="12.398" viewBox="0 0 13 12.398">
                    <path d="M17.98,11.8c-.053-.162-.184-.272-.577-.309l-3.59-.333a.442.442,0,0,1-.415-.3L11.972,7.541c-.156-.363-.3-.454-.472-.454s-.315.091-.472.454L9.6,10.853a.442.442,0,0,1-.415.3l-3.59.333c-.393.037-.525.146-.577.309s-.011.328.286.589l2.709,2.38a.443.443,0,0,1,.159.488L7.379,18.77c-.087.386-.023.544.115.645s.309.112.648-.09l3.1-1.841a.441.441,0,0,1,.513,0l3.1,1.841c.34.2.51.19.649.09s.2-.259.115-.645l-.793-3.517a.443.443,0,0,1,.159-.488l2.709-2.38C17.992,12.123,18.033,11.958,17.98,11.8Z" transform="translate(-5 -7.087)" fill="#fbb03b"></path>
                  </svg>
                </div><span>1</span>
                <div class="bar">
            ...
            <div class="comments">
              <div class="comment">
                <div class="comment__user-photo"><img src="images/user-1.png" alt="user photo"/></div>
                <div class="comment__content">
                  <div class="comment__user-name">John Doe</div>
                  <div class="comment__user-rating">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="98" height="13.351" viewBox="0 0 98 13.351">
                      <defs>
                        <linearGradient id="g1" x1="0.5" y1="0.5" x2="0.541" y2="0.5" gradientUnits="objectBoundingBox">
                          <stop offset="0" stop-color="#fbb03b"></stop>
                          <stop offset="1" stop-color="#c2c2c2">   </stop>
                        </linearGradient>
                      </defs>
              ...
              <div class="comment">
                <div class="comment__user-photo"><img src="images/user-2.png" alt="user photo"/></div>
                <div class="comment__content">
                  <div class="comment__user-name">Eveline Gosok</div>
                  <div class="comment__user-rating">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="98" height="13.351" viewBox="0 0 98 13.351">
                      <defs>
                        <linearGradient id="g2" x1="0.5" y1="0.5" x2="0.541" y2="0.5" gradientUnits="objectBoundingBox">
                          <stop offset="0" stop-color="#fbb03b"></stop>
                          <stop offset="1" stop-color="#c2c2c2">   </stop>
                        </linearGradient>
                      </defs>
              ...
              <div class="comment">
                <div class="comment__user-photo"><img src="images/user-3.png" alt="user photo"/></div>
                <div class="comment__content">
                  <div class="comment__user-name">Anne Okombo</div>
                  <div class="comment__user-rating">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="98" height="13.351" viewBox="0 0 98 13.351">
                      <defs>
                        <linearGradient id="g3" x1="0.5" y1="0.5" x2="0.541" y2="0.5" gradientUnits="objectBoundingBox">
                          <stop offset="0" stop-color="#fbb03b"></stop>
                          <stop offset="1" stop-color="#c2c2c2">   </stop>
                        </linearGradient>
                      </defs>
