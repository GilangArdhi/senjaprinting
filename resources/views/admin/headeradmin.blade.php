                    ...
                    <li class="nav-item dropdown">
                        ...
                        >
                            <a href="#" class="dropdown-item">
                                <div class="media">
                                    <img
                                        src="{{asset('assets/tempad/dist/img/user1-128')}}"
                                        alt="User Avatar"
                            ...
                            <a href="#" class="dropdown-item">
                                <div class="media">
                                    <img
                                        src="{{asset('assets/tempad/dist/img/user8-128')}}"
                                        alt="User Avatar"
                            ...
                            <a href="#" class="dropdown-item">
                                <div class="media">
                                    <img
                                        src="{{asset('assets/tempad/dist/img/user3-128')}}"
                                        alt="User Avatar"
                                        class="img-size-50 img-circle mr-3"
                                    />
                                    <div class="media-body">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                <a href="{{asset('assets/tempad/index3.html')}}" class="brand-link">
                    <img
                        ...
                        style="opacity: 0.8"
                    />
                    <span class="brand-text font-weight-light">Senja Printing</span>
                </a>
                        ...
                        >
                            <li class="nav-item">
                                ...
                                <!-- <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a
                                            href="{{asset('assets/tempad/index.html')}}"
                                            class="nav-link"
                                        >
                                            <i
                                    ...
                                    <li class="nav-item">
                                        <a
                                            href="{{asset('assets/tempad/index2.html')}}"
                                            class="nav-link"
                                        >
                                            <i
                                                class="far fa-circle nav-icon"
                                    ...
                                    <li class="nav-item">
                                        <a
                                            href="{{asset('assets/tempad/index3.html')}}"
                                            class="nav-link"
                                        >
                                            <i
                                                class="far fa-circle nav-icon"
                            ...
                            <li class="nav-item menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a
                                            href="{{asset('assets/tempad/starter.html')}}"
                                            class="nav-link"
                                        >
                                            <i
                                                class="far fa-circle nav-icon"
                            ...
                            <li class="nav-item">
                                <a href="{{asset('assets/tempad/iframe.html')}}" class="nav-link">
