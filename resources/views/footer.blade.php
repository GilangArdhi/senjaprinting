  <div class="container spacing">
    ...
    <div style="background-color: #EBA51A">
...
<script>
  document.getElementById("showButton").addEventListener("click", function() {
    ...
    <p class="footer__credit" style="background-color: #FFFFFF; padding-bottom: 20px;">Copyright 2023 - Senja Printing - All Right Reserved</p>
